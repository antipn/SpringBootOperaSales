...
public class LoggingAspect {
    ...
    @After("execution(* ru.learnup.java2.antipn.spring.boot.operasales.services.PublicEventManagerImpl.sellTicketInDB(..))")
    public void logAfter(JoinPoint joinPoint) {
        System.out.println("logAfter() is running!");
        System.out.println("Отслеживаем работу продажи билета в методе : " + joinPoint.getSignature().getName());
        System.out.println("Письмо о продаже билета выслано на почту менеджера");
    }
